...
const discordId = "715262981927075932";
...
const reloadUser = async (data) => {
  ...
  <a class="discord" href="https://discord.gg/N46QJ8S8Bf" target="_blank">Discord</a>`);
...
function showGithubRepos() {
  const getGitHubData = async () => {
    const response = await fetch(properties.github_api.baseURL + '/users/BenRecep/repos');
  ...
  getGitHubData().then(data => {
    ...
    <p>
    <a>${repository.language}</a> <a class="lang"></a>
    </p>`;
  ...
  const socials = [
    {
      ...
      href: 'https://www.instagram.com/arkraftstudios/',
      tippy: 'Instagram'
    },
    {
      ...
      href: 'mailto:arkraftstudios@gmail.com',
      tippy: 'E-Mail'
    },
    {
    ...
    },
    {
      ...
      href: 'https://github.com/BenRecep',
      tippy: 'GitHub'
    }
  ];
